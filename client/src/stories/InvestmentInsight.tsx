...
const InvestmentInsight: React.FC<InvestmentInsightProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow p-3 font-sans flex flex-col h-full overflow-hidden ${className}`}
    >
      {/* Header Section */}
      ...
      {/* Location */}
      <div className="flex items-center gap-1 text-gray-500 mb-2 flex-shrink-0">
      ...
      <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
        {/* Description */}
        <p
          className="text-sm text-gray-600 mb-4 leading-snug line-clamp-3 mt-2"
          style={{
            display: "-webkit-box",
            WebkitLineClamp: 3,
        ...
        {/* Metrics Grid */}
        <div className="grid grid-cols-2 gap-x-4 gap-y-3 mb-4 flex-shrink-0">
          {/* Investment Required */}
