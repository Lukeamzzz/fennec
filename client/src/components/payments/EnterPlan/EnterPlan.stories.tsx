  ...
  parameters: {
    ...
    docs: {
      page: () => (
        <>
          <Title />
          <h1>Plan Empresarial</h1>
          <p>Julián C</p>
          <p>Este componente muestra la tarjeta del plan empresarial con las siguientes características:</p>
          <ul>
            <li>Diseño oscuro con detalles en naranja para destacar del resto de planes</li>
...
const PricingPage = () => {
  ...
  const handlePlanSelection = () => {
    console.log('Plan empresarial seleccionado');
    ...
    <div className="container mx-auto py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <EnterPlan 
          ...
          annualPrice={2599}
          features={[
            'Acceso ilimitado a todas las propiedades',
        ...
        {/* Otros planes aquí */}
          ...
          <h2>Diseño</h2>
          <p>El diseño utiliza un esquema de colores oscuro con acentos en naranja para crear contraste y destacar la opción empresarial como la más premium entre los planes ofrecidos.</p>
          <Primary />
          <Controls />
          <Stories />
        </>
      ...
      description: {
        component: 'Componente de tarjeta para mostrar el plan empresarial con precios y características.'
      },
    },
  },
  tags: ['autodocs'],
