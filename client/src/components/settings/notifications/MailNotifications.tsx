    ...
    return(
        <div className="bg-white rounded-lg p-6 mt-2">
            <div className="flex items-center justify-center">
                ...
                <h2 className="text-xl font-medium align-middle pl-2">Canales de Notificaciones</h2>
            </div>


            <p className="text-gray-500 text-center text-sm mb-6">

                Configura como te gustaría que te llegaran las notificaciones
            </p>
            ...
            <div className="flex justify-between">
                ...
                <div>
                    <div className="flex items-center justify-left">
                        ...
                        <h3 className=" text-left text-sm pl-2 align-middle">Notificaciones de correo</h3>
                    </div>

                    <p className="text-gray-500 text-sm mb-6">Recibe actualizaciones a través de correo electrónico</p>
                </div>
