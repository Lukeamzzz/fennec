      ...
      <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-4 max-w-xs">
        ...
        <div className="mb-4 pb-3 border-b border-gray-200">
          ...
          <div className="flex items-center mb-2">
            <div className="w-4 h-4 rounded mr-2 border-2" style={{ backgroundColor: '#FFF3E0', borderColor: '#F56C12' }}></div>
        ...
        {showColoniasLayer && (
          <div className="mb-3">
            ...
            <div className="flex items-center mb-2">
              <div className="w-4 h-4 rounded mr-2 border-2" style={{ backgroundColor: '#E8F5E8', borderColor: '#2E7D32' }}></div>
        ...
        {showPropertiesLayer && (
          <div className="mb-3">
            ...
            <div className="space-y-1">
              <div className="flex items-center">
                <div className="w-3 h-3 rounded-full mr-2 border-2" style={{ backgroundColor: '#3B82F6', borderColor: '#1E40AF' }}></div>
                <span className="text-xs text-gray-700">🏠 Casas</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 rounded-full mr-2 border-2" style={{ backgroundColor: '#10B981', borderColor: '#047857' }}></div>
