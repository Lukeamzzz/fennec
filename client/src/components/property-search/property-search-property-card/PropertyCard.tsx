      ...
      <div className="p-6" onClick={onClick}>
        ...
        <div className="flex items-center justify-between border-t pt-4">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-gray-700">{beds} {beds === 1 ? 'Hab' : 'Habs'}</span>
          </div>
          
          <div className="flex items-center">
            <Bath size={20} className="text-gray-500" />
            <span className="ml-2 text-gray-700">{baths} {baths === 1 ? 'Baño' : 'Baños'}</span>
          </div>
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 text-gray-700">{area} m²</span>
          </div>
        </div>
      </div>
